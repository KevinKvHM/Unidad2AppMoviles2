...
class QuoteRepositoryImpl @Inject constructor(
    ...
    // quoteDAO: QuoteDAO
    private val localDataSourceImpl: QuoteLocalDataSourceImpl,
    private val remoteDataSourceImpl: QuoteRemoteDataSourceImpl
    ...
    override suspend  fun getQuotes(): Flow<List<QuoteModel>> {
        val remoteQuotes =
        try {
            remoteDataSourceImpl.getQuotes()
        } catch (ex: Exception) {
            when (ex) {
