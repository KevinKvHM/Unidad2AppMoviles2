...
import dev.cardoso.quotesmvvm.domain.usecase.GetQuoteUseCase
...
class QuoteViewModel @Inject  constructor(
    ...
    private val getRandomUseCase: GetQuoteRandomUseCase
    ): ViewModel() {
    ...
    fun getQuotes() {
        viewModelScope.launch {
            ...
            val quotes = getquoteUseCase.getQuotes().first()
    ...
    fun randomQuote() {
        viewModelScope.launch {
            ...
            _quoteModel.value = getRandomUseCase.getQuoteRandom().first()
